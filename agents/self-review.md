...
Run this agent on a PR branch after implementation is complete but before marking the PR as ready for human review. Typically invoked by the dev-loop agent as Step 18.
